...
export const whitetheme = { primary: '#1c1f1f',btnprimary: '#30c268', secondary: '#FF6584',secprimary: '#3032c2', background:'#FFFFFF', surface: '#F5F5F5', text: '#1A1A2E', textMuted: '#6B7280', border: '#E5E7EB', success: '#10B981', error: '#EF4444', warning: '#F59E0B', }; 
